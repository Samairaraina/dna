...
const challenges = [
  {
    ...
    description: "CRISPR can inadvertently edit unintended genomic sites, potentially causing harmful mutations. Optimization reduces off-target effects by up to 99%.",
    icon: (
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {challenges.map((challenge, i) => (
            ...
            >
              <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${challenge.color} p-3 text-white mb-4 group-hover:scale-110 transition-transform`}>
                {challenge.icon}
              </div>
              ...
              <div key={i} className="text-center">
                <div className="relative w-24 h-24 mx-auto mb-4">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-xl font-bold text-gray-900 dark:text-white">{benefit.value}%</span>
                  </div>
                </div>
