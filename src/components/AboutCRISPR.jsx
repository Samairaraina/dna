  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.color} p-3 text-white shadow-lg flex-shrink-0`}>
          {step.icon}
        </div>
        {index < steps.length - 1 && (
          <div className="w-0.5 h-full min-h-[3rem] bg-gradient-to-b from-aqua-400/50 to-transparent mt-2" />
        )}
      </div>
      <div className="glass-card p-4 flex-1 mb-6">
    ...
    <section id="about" className="section-padding bg-gray-50/50 dark:bg-gray-900/50">
      <div className="container-custom" ref={ref}>
        ...
        <motion.div
          ...
          className="mt-10 glass-card p-6 md:p-8 text-center max-w-4xl mx-auto"
        >
